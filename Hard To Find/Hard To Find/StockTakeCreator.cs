...
{
    public class StockTakeCreator
    {
        private DatabaseManager dbManager;
        int numStock;
        double totalStockPrice;

        public StockTakeCreator()
        {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "00AB286F", RsidParagraphAddition = "00DD4FE6", RsidParagraphProperties = "00DD4FE6", RsidRunAdditionDefault = "00DD4FE6" };
            ...
            text1.Text = "Current Stock Take: " + currDate;
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "00DD4FE6", RsidRunAdditionDefault = "00DD4FE6" };
            ...
            GridColumn gridColumn1 = new GridColumn() { Width = "4508" };
            GridColumn gridColumn2 = new GridColumn() { Width = "4508" };

            tableGrid1.Append(gridColumn1);
            tableGrid1.Append(gridColumn2);

            TableRow tableRow1 = new TableRow() { RsidTableRowAddition = "00DD4FE6", RsidTableRowProperties = "00DD4FE6" };

            TableCell tableCell1 = new TableCell();

            TableCellProperties tableCellProperties1 = new TableCellProperties();
            TableCellWidth tableCellWidth1 = new TableCellWidth() { Width = "4508", Type = TableWidthUnitValues.Dxa };

            tableCellProperties1.Append(tableCellWidth1);

            Paragraph paragraph3 = new Paragraph() { RsidParagraphMarkRevision = "00DD4FE6", RsidParagraphAddition = "00DD4FE6", RsidRunAdditionDefault = "00DD4FE6" };
            ...
            Run run2 = new Run() { RsidRunProperties = "00DD4FE6" };
            ...
            TableCellWidth tableCellWidth2 = new TableCellWidth() { Width = "4508", Type = TableWidthUnitValues.Dxa };

            tableCellProperties2.Append(tableCellWidth2);

            Paragraph paragraph4 = new Paragraph() { RsidParagraphMarkRevision = "00DD4FE6", RsidParagraphAddition = "00DD4FE6", RsidRunAdditionDefault = "00DD4FE6" };
            ...
            Run run5 = new Run() { RsidRunProperties = "00DD4FE6" };
            ...
            text6.Text = " $" + String.Format("{0:n}", totalStockPrice);
            ...
            Paragraph paragraph5 = new Paragraph() { RsidParagraphAddition = "00005ADC", RsidRunAdditionDefault = "00005ADC" };
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidR = "00005ADC" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00DD4FE6" };
            Rsid rsid1 = new Rsid() { Val = "00005ADC" };
            Rsid rsid2 = new Rsid() { Val = "00DD4FE6" };
            ...
            OpenXmlUnknownElement openXmlUnknownElement2 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement("<w15:docId w15:val=\"{A4A0ACAA-BAFC-4658-8853-7D33AF49E888}\" xmlns:w15=\"http://schemas.microsoft.com/office/word/2012/wordml\" />");
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            runPropertiesBaseStyle1.Append(fontSize10);
            ...
            SpacingBetweenLines spacingBetweenLines1 = new SpacingBetweenLines() { After = "160" };
            ...
            Rsid rsid3 = new Rsid() { Val = "00DD4FE6" };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2017-03-02T12:37:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2017-03-02T12:40:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
